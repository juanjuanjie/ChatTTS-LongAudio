...
- Voices can be selected via the `custom_voice` parameter in the WebUI or API.
...
| `voice` | `2222` | Preset voice |
| `custom_voice` | `0` | Custom voice seed, takes precedence over `voice` |
